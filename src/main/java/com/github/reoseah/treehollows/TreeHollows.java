...
public class TreeHollows implements ModInitializer {
    ...
    public static TreeHollowsConfig config = new TreeHollowsConfig();
    ...
    public static final Map<Identifier, Block> TREE_HOLLOWS_MAP = new HashMap<>();
    ...
    public static final Block TWISTED_HOLLOW = FabricLoader.getInstance().isModLoaded("architects_palette") ? new TreeHollowBlock(FabricBlockSettings.of(Material.WOOD, MapColor.PURPLE).strength(2.0f, 3.0F).sounds(BlockSoundGroup.WOOD)) : null;

    static {
        TREE_HOLLOWS_MAP.put(new Identifier("oak_log"), OAK_HOLLOW);
        TREE_HOLLOWS_MAP.put(new Identifier("spruce_log"), SPRUCE_HOLLOW);
        TREE_HOLLOWS_MAP.put(new Identifier("birch_log"), BIRCH_HOLLOW);
        TREE_HOLLOWS_MAP.put(new Identifier("jungle_log"), JUNGLE_HOLLOW);
        TREE_HOLLOWS_MAP.put(new Identifier("acacia_log"), ACACIA_HOLLOW);
        TREE_HOLLOWS_MAP.put(new Identifier("dark_oak_log"), DARK_OAK_HOLLOW);
        if (FabricLoader.getInstance().isModLoaded("architects_palette")) {
            TREE_HOLLOWS_MAP.put(new Identifier("architects_palette:twisted_log"), TWISTED_HOLLOW);
        }
    }
    ...
    private static <T> T register(Registry<? super T> registry, String name, T entry) {
